...
file_handler = logging.FileHandler("video_processor.log")
...
def apply_transition(clip1, clip2, transition, duration):
        ...
        if len(video_clips) > 1:
            ...
            if st.button("Process Final Video"):
                try:
                    ...
                    logger.error("Error processing final video: %s", e)
...
if __name__ == "__main__":
    process_videos_with_transitions()